...
#增加的一句代码，解决RuntimeError: cuDNN error: CUDNN_STATUS_EXECUTION_FAILED
...
if __name__ == "__main__":
    ...
    img_list, init_bbox, gt, savefig_dir, display, result_path = gen_config(args)  #返回img_list, init_bbox, gt, savefig_dir, args.display, result_path
